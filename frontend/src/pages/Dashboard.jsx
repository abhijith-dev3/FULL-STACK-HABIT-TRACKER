    ...
    <div className="space-y-4">
      ...
      {habits.length === 0 ? (
        <div className="text-center py-20 text-gray-400">
          ...
          <p className="text-sm mt-2">Start by adding your first habit above</p>
        </div>
      ) : (
        habits.map((habit) => (
          <div
            key={habit._id}
            className="flex justify-between items-center bg-gray-900/60 backdrop-blur-md p-5 rounded-2xl border border-gray-800 hover:border-green-500 transition"
          >
